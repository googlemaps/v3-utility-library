...
function P(a) {
  ...
  this.Q = this.k(c, this.a, this.c, this.w, this.G)
}
P.prototype = new L;
...
P.prototype.n = function(a) {
  ...
  c = (this.Q + (c - this.j) / this.A) / (this.a * (1 - this.c / 4 - 3 * this.w / 64 - 5 * this.G / 256));
...
function Z(a, b) {
  ...
  if(b.J) {
    var c = t(this.d.url, "", "://");
    this.ba = c + "://" + b.J + t(this.d.url, c + "://" + t(this.d.url, "://", "/"), "");
    this.W = parseInt(t(b.J, "[", "]"), 10)
  }
...
Z.prototype.getTileUrl = function(a, b) {
  ...
  if(!isNaN(a.x) && !isNaN(a.y) && c >= 0 && a.x >= 0 && a.y >= 0) {
    ...
    g = this.d;
    if(g.fullExtent) {
      g.U = g.U || H(g.fullExtent);
      g = g.U
    }else {
      g = null
    }
    if(this.d.singleFusedMapCache === false || b > this.T) {
      c = {f:"image"};
      c.bounds = i;
      c.format = "png32";
      c.width = f.width;
...
new m.OverlayView;
var ia = Z;window.onload = function() {
  ...
  var b = new ia("http://maps.ci.charlotte.nc.us/ArcGIS/rest/services/GET/BaseMapWM/MapServer", {J:"mt[4].ci.charlotte.nc.us"});
  b = new $([b], {name:"ArcGIS"});

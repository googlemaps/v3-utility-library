...
var m = google.maps, o, q, r, s = {Z:null, T:false}, t = {}, u = {};
function v(a, b, c) {
...
function P(a) {
  ...
  this.R = this.k(c, this.a, this.c, this.w, this.H)
}
P.prototype = new L;
...
P.prototype.n = function(a) {
  ...
  c = (this.R + (c - this.j) / this.A) / (this.a * (1 - this.c / 4 - 3 * this.w / 64 - 5 * this.H / 256));
...
u.ka = function(a, b) {
  ...
  if(b instanceof L) {
    ...
    if(e !== "") {
      ...
      d.r = parseFloat(f[1]);
      d.L = parseFloat(f[2]);
      d.M = parseFloat(v(c, '"Latitude_Of_Origin",', "]"));
...
function Z(a, b) {
  ...
  if(b.K) {
    var c = v(this.g.url, "", "://");
    this.ba = c + "://" + b.K + v(this.g.url, c + "://" + v(this.g.url, "://", "/"), "");
    this.W = parseInt(v(b.K, "[", "]"), 10)
  }
...
Z.prototype.getTileUrl = function(a, b) {
  ...
  if(!isNaN(a.x) && !isNaN(a.y) && c >= 0 && a.x >= 0 && a.y >= 0) {
    ...
    if(this.g.singleFusedMapCache === false || b > this.U) {
...
new m.OverlayView;
var ha = Z;window.onload = function() {
  ...
  var b = new ha("http://maps.ci.charlotte.nc.us/ArcGIS/rest/services/GET/BaseMapWM/MapServer", {K:"mt[4].ci.charlotte.nc.us"});
  b = new $([b], {name:"ArcGIS"});

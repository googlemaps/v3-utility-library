...
function O(a) {
  a = a || {};
  M.call(this, a);
  var b = a.I, c = a.M * j, d = a.N * j, e = a.J * j;
  this.a = a.p / a.unit;
  this.e = a.m * j;
  this.h = a.G;
  this.i = a.H;
...
function Q(a) {
  ...
  this.O = this.j(c, this.a, this.c, this.u, this.F)
}
Q.prototype = new M;
...
Q.prototype.forward = function(a) {
  ...
  return[this.h + this.v * a * (c + (1 - d + e) * Math.pow(c, 3) / 6 + (5 - 18 * d + d * d + 72 * e - 58 * this.l) * Math.pow(c, 5) / 120), this.i + this.v * (f - this.O) + a * Math.tan(b) * (c * c / 2 + (5 - d + 9 * e + 4 * e * e) * Math.pow(c, 4) / 120 + (61 - 58 * d + d * d + 600 * e - 330 * this.l) * Math.pow(c, 6) / 720)]
};
Q.prototype.o = function(a) {
  var b = a[0], c = a[1];
  a = (1 - Math.sqrt(1 - this.c)) / (1 + Math.sqrt(1 - this.c));
  c = (this.O + (c - this.i) / this.v) / (this.a * (1 - this.c / 4 - 3 * this.u / 64 - 5 * this.F / 256));
...
Z.prototype.onAdd = function() {
  ...
  this.z && z(a, this.z);
  this.V = n.event.addListener(this.getMap(), "bounds_changed", ca(this.A, this));
  a = this.getMap();

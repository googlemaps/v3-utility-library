...
var n = google.maps, o, p, r, s = {S:null, Q:false}, t = {}, u = {};
function v(a, b, c) {
...
function da(a, b, c) {
  b.I ? a.push(b.copyrightText) : n.event.addListenerOnce(b, "load", function() {
    K(c)
  })
}
function K(a) {
...
function O(a) {
  a = a || {};
  M.call(this, a);
  var b = a.G, c = a.M * j, d = a.N * j, e = a.H * j;
  this.a = a.p / a.unit;
  this.e = a.m * j;
  this.h = a.D;
  this.i = a.F;
  ...
  this.B = a / (this.b * Math.pow(c, this.b));
  this.g = this.r(this.a, this.B, e, this.b)
}
O.prototype = new M;
...
i.forward = function(a) {
  var b = a[0] * j;
  a = this.r(this.a, this.B, P(this, a[1] * j, this.d), this.b);
  b = this.b * (b - this.e);
...
i.o = function(a) {
  ...
  b = Math.pow((this.b > 0 ? 1 : -1) * Math.sqrt(b * b + (this.g - c) * (this.g - c)) / (this.a * this.B), 1 / this.b);
...
function Q(a) {
  ...
  this.O = this.j(c, this.a, this.c, this.t, this.C)
}
Q.prototype = new M;
...
Q.prototype.forward = function(a) {
  ...
  var f = this.j(b, this.a, this.c, this.t, this.C);
  return[this.h + this.u * a * (c + (1 - d + e) * Math.pow(c, 3) / 6 + (5 - 18 * d + d * d + 72 * e - 58 * this.l) * Math.pow(c, 5) / 120), this.i + this.u * (f - this.O) + a * Math.tan(b) * (c * c / 2 + (5 - d + 9 * e + 4 * e * e) * Math.pow(c, 4) / 120 + (61 - 58 * d + d * d + 600 * e - 330 * this.l) * Math.pow(c, 6) / 720)]
};
Q.prototype.o = function(a) {
  var b = a[0], c = a[1];
  a = (1 - Math.sqrt(1 - this.c)) / (1 + Math.sqrt(1 - this.c));
  c = (this.O + (c - this.i) / this.u) / (this.a * (1 - this.c / 4 - 3 * this.t / 64 - 5 * this.C / 256));
...
function S(a) {
  ...
  this.b = (a * a - b * b) / (d - c);
  this.A = a * a + this.b * c;
  this.g = this.r(this.a, this.A, this.b, e)
}
S.prototype = new M;
...
i.forward = function(a) {
  var b = a[0] * j;
  a = this.r(this.a, this.A, this.b, T(this, a[1] * j, this.d));
  b = this.b * (b - this.e);
  return[this.h + a * Math.sin(b), this.i + this.g - a * Math.cos(b)]
};
i.o = function(a) {
  ...
  c = (this.A - c * c * this.b * this.b / (this.a * this.a)) / this.b;
...
u.ba = function(a, b) {
  ...
  if(b instanceof M) {
    ...
    if(e !== "") {
      ...
      d.p = parseFloat(f[1]);
      d.G = parseFloat(f[2]);
      d.H = parseFloat(v(c, '"Latitude_Of_Origin",', "]"));
      d.m = parseFloat(v(c, '"Central_Meridian",', "]"));
      d.D = parseFloat(v(c, '"False_Easting",', "]"));
      d.F = parseFloat(v(c, '"False_Northing",', "]"))
    }
    switch(e) {
      case "":
        c = new M(d);
...
function Y(a) {
  ...
  this.z = a ? t[a.spatialReference.wkid || a.spatialReference.wkt] : r;
  if(!this.z) {
    throw new Error("unsupported Spatial Reference");
  }
  this.T = a ? a.lods[0].resolution : 156543.033928;
  this.minZoom = Math.floor(Math.log(this.z.n() / this.T / 256) / Math.LN2 + 0.5);
...
Y.prototype.fromLatLngToPoint = function(a, b) {
  ...
  var c = this.z.forward([a.lng(), a.lat()]), d = b || new n.Point(0, 0);
  d.x = (c[0] - this.$) / this.U;
...
function Z(a, b) {
  b = b || {};
  this.R = a instanceof V ? a : new V(a);
...
Z.prototype.onAdd = function() {
  ...
  this.w && z(a, this.w);
  this.V = n.event.addListener(this.getMap(), "bounds_changed", ca(this.K, this));
  a = this.getMap();
